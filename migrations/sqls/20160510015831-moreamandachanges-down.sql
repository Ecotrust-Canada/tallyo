alter table box drop column country_origin;
...
alter table supplier drop column msc_code;
alter table shipping_unit drop column country_origin;

alter table lot drop column receive_date;
