alter table supplier add column msc_code character varying;
alter table shipping_unit add column country_origin character varying;

alter table lot add column receive_date date;
...
ALTER TABLE public.harvester_lot
  ...
  alter table box add column country_origin character varying;