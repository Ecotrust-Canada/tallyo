CREATE OR REPLACE VIEW loin_scan AS
 SELECT loin_lot.loin_number,
  ...
  GROUP BY loin_lot.loin_number, loin_lot.box_number, 
loin_lot.lot_number, loin_lot.grade, loin_lot.weight_1, 
scan.station_code, loin_lot.internal_lot_code; ALTER TABLE loin_scan
